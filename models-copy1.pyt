...
class Food(models.Model):
    ...
    nameSV = models.CharField(max_length=100)
    description = models.CharField(max_length=1000, blank=True)
    descriptionSV = models.CharField(max_length=1000, blank=True)
    link = models.CharField(max_length=1000, blank=True)
    extra = models.CharField(max_length=1000, blank=True)
    energy = models.DecimalField(default=0, max_digits=8, decimal_places=2)
    fat = models.DecimalField(default=0, max_digits=8, decimal_places=2)
    saturatedFat = models.DecimalField(default=0, max_digits=8, decimal_places=2)
    carbohydrate = models.DecimalField(default=0, max_digits=8, decimal_places=2)
    sugar = models.DecimalField(default=0, max_digits=8, decimal_places=2)
    ...
    salt = models.DecimalField(default=0, max_digits=12, decimal_places=10)
    def __str__(self):
...
class Product(models.Model):
    ...
    nameSV = models.CharField(_('Product|nameSV'), max_length=100)
